...
Base package: `io.zenoh.jni`

## package `io.zenoh.jni.bytes`

- `val ENCODING_APPLICATION_CBOR: String` — binding expression
- `val ENCODING_APPLICATION_CBOR_ID: u16` — binding expression
- `val ENCODING_APPLICATION_CDR: String` — binding expression
- `val ENCODING_APPLICATION_CDR_ID: u16` — binding expression
- `val ENCODING_APPLICATION_COAP_PAYLOAD: String` — binding expression
- `val ENCODING_APPLICATION_COAP_PAYLOAD_ID: u16` — binding expression
- `val ENCODING_APPLICATION_JAVA_SERIALIZED_OBJECT: String` — binding expression
- `val ENCODING_APPLICATION_JAVA_SERIALIZED_OBJECT_ID: u16` — binding expression
- `val ENCODING_APPLICATION_JSON: String` — binding expression
- `val ENCODING_APPLICATION_JSONPATH: String` — binding expression
- `val ENCODING_APPLICATION_JSONPATH_ID: u16` — binding expression
- `val ENCODING_APPLICATION_JSON_ID: u16` — binding expression
- `val ENCODING_APPLICATION_JSON_PATCH_JSON: String` — binding expression
- `val ENCODING_APPLICATION_JSON_PATCH_JSON_ID: u16` — binding expression
- `val ENCODING_APPLICATION_JSON_SEQ: String` — binding expression
- `val ENCODING_APPLICATION_JSON_SEQ_ID: u16` — binding expression
- `val ENCODING_APPLICATION_JWT: String` — binding expression
- `val ENCODING_APPLICATION_JWT_ID: u16` — binding expression
- `val ENCODING_APPLICATION_MP4: String` — binding expression
- `val ENCODING_APPLICATION_MP4_ID: u16` — binding expression
- `val ENCODING_APPLICATION_OCTET_STREAM: String` — binding expression
- `val ENCODING_APPLICATION_OCTET_STREAM_ID: u16` — binding expression
- `val ENCODING_APPLICATION_OPENMETRICS_TEXT: String` — binding expression
- `val ENCODING_APPLICATION_OPENMETRICS_TEXT_ID: u16` — binding expression
- `val ENCODING_APPLICATION_PROTOBUF: String` — binding expression
- `val ENCODING_APPLICATION_PROTOBUF_ID: u16` — binding expression
- `val ENCODING_APPLICATION_PYTHON_SERIALIZED_OBJECT: String` — binding expression
- `val ENCODING_APPLICATION_PYTHON_SERIALIZED_OBJECT_ID: u16` — binding expression
- `val ENCODING_APPLICATION_SOAP_XML: String` — binding expression
- `val ENCODING_APPLICATION_SOAP_XML_ID: u16` — binding expression
- `val ENCODING_APPLICATION_SQL: String` — binding expression
- `val ENCODING_APPLICATION_SQL_ID: u16` — binding expression
- `val ENCODING_APPLICATION_XML: String` — binding expression
- `val ENCODING_APPLICATION_XML_ID: u16` — binding expression
- `val ENCODING_APPLICATION_X_WWW_FORM_URLENCODED: String` — binding expression
- `val ENCODING_APPLICATION_X_WWW_FORM_URLENCODED_ID: u16` — binding expression
- `val ENCODING_APPLICATION_YAML: String` — binding expression
- `val ENCODING_APPLICATION_YAML_ID: u16` — binding expression
- `val ENCODING_APPLICATION_YANG: String` — binding expression
- `val ENCODING_APPLICATION_YANG_ID: u16` — binding expression
- `val ENCODING_AUDIO_AAC: String` — binding expression
- `val ENCODING_AUDIO_AAC_ID: u16` — binding expression
- `val ENCODING_AUDIO_FLAC: String` — binding expression
- `val ENCODING_AUDIO_FLAC_ID: u16` — binding expression
- `val ENCODING_AUDIO_MP4: String` — binding expression
- `val ENCODING_AUDIO_MP4_ID: u16` — binding expression
- `val ENCODING_AUDIO_OGG: String` — binding expression
- `val ENCODING_AUDIO_OGG_ID: u16` — binding expression
- `val ENCODING_AUDIO_VORBIS: String` — binding expression
- `val ENCODING_AUDIO_VORBIS_ID: u16` — binding expression
- `val ENCODING_IMAGE_BMP: String` — binding expression
- `val ENCODING_IMAGE_BMP_ID: u16` — binding expression
- `val ENCODING_IMAGE_GIF: String` — binding expression
- `val ENCODING_IMAGE_GIF_ID: u16` — binding expression
- `val ENCODING_IMAGE_JPEG: String` — binding expression
- `val ENCODING_IMAGE_JPEG_ID: u16` — binding expression
- `val ENCODING_IMAGE_PNG: String` — binding expression
- `val ENCODING_IMAGE_PNG_ID: u16` — binding expression
- `val ENCODING_IMAGE_WEBP: String` — binding expression
- `val ENCODING_IMAGE_WEBP_ID: u16` — binding expression
- `val ENCODING_TEXT_CSS: String` — binding expression
- `val ENCODING_TEXT_CSS_ID: u16` — binding expression
- `val ENCODING_TEXT_CSV: String` — binding expression
- `val ENCODING_TEXT_CSV_ID: u16` — binding expression
- `val ENCODING_TEXT_HTML: String` — binding expression
- `val ENCODING_TEXT_HTML_ID: u16` — binding expression
- `val ENCODING_TEXT_JAVASCRIPT: String` — binding expression
- `val ENCODING_TEXT_JAVASCRIPT_ID: u16` — binding expression
- `val ENCODING_TEXT_JSON5: String` — binding expression
- `val ENCODING_TEXT_JSON5_ID: u16` — binding expression
- `val ENCODING_TEXT_JSON: String` — binding expression
- `val ENCODING_TEXT_JSON_ID: u16` — binding expression
- `val ENCODING_TEXT_MARKDOWN: String` — binding expression
- `val ENCODING_TEXT_MARKDOWN_ID: u16` — binding expression
- `val ENCODING_TEXT_PLAIN: String` — binding expression
- `val ENCODING_TEXT_PLAIN_ID: u16` — binding expression
- `val ENCODING_TEXT_XML: String` — binding expression
- `val ENCODING_TEXT_XML_ID: u16` — binding expression
- `val ENCODING_TEXT_YAML: String` — binding expression
- `val ENCODING_TEXT_YAML_ID: u16` — binding expression
- `val ENCODING_VIDEO_H261: String` — binding expression
- `val ENCODING_VIDEO_H261_ID: u16` — binding expression
- `val ENCODING_VIDEO_H263: String` — binding expression
- `val ENCODING_VIDEO_H263_ID: u16` — binding expression
- `val ENCODING_VIDEO_H264: String` — binding expression
- `val ENCODING_VIDEO_H264_ID: u16` — binding expression
- `val ENCODING_VIDEO_H265: String` — binding expression
- `val ENCODING_VIDEO_H265_ID: u16` — binding expression
- `val ENCODING_VIDEO_H266: String` — binding expression
- `val ENCODING_VIDEO_H266_ID: u16` — binding expression
- `val ENCODING_VIDEO_MP4: String` — binding expression
- `val ENCODING_VIDEO_MP4_ID: u16` — binding expression
- `val ENCODING_VIDEO_OGG: String` — binding expression
- `val ENCODING_VIDEO_OGG_ID: u16` — binding expression
- `val ENCODING_VIDEO_RAW: String` — binding expression
- `val ENCODING_VIDEO_RAW_ID: u16` — binding expression
- `val ENCODING_VIDEO_VP8: String` — binding expression
- `val ENCODING_VIDEO_VP8_ID: u16` — binding expression
- `val ENCODING_VIDEO_VP9: String` — binding expression
- `val ENCODING_VIDEO_VP9_ID: u16` — binding expression
- `val ENCODING_ZENOH_BYTES: String` — binding expression
- `val ENCODING_ZENOH_BYTES_ID: u16` — binding expression
- `val ENCODING_ZENOH_SERIALIZED: String` — binding expression
- `val ENCODING_ZENOH_SERIALIZED_ID: u16` — binding expression
- `val ENCODING_ZENOH_STRING: String` — binding expression
- `val ENCODING_ZENOH_STRING_ID: u16` — binding expression

## package `io.zenoh.jni.logger`

- `init_android_logs` — `fun initAndroidLogs(filter: String, onError: JniErrorHandler<Unit>)`
- `init_zenoh_logs_from_env_or` — `fun initZenohLogsFromEnvOr(fallbackFilter: String, onError: JniErrorHandler<Unit>)`
- `try_init_zenoh_logs_from_env` — `fun tryInitZenohLogsFromEnv(onError: JniErrorHandler<Unit>)`
...
- `advanced_publisher_matching_status` — `fun matchingStatus(onBindingError: JniErrorHandler<Boolean>, onError: ErrorHandler<Boolean>): Boolean`
  - shaped by: domain error `Error` decomposed → onError [message] (binding failures → onBindingError)
- `advanced_publisher_put` — `fun put(payload: ByteArray, encodingSel: Int, encoding00: Int?, encoding01: ByteArray?, encoding1: Encoding?, attachment: ByteArray?, onBindingError: JniErrorHandler<Unit>, onError: ErrorHandler<Unit>)`
  - shaped by: param `attachment` expanded from `ZBytes` — variants [zbytes_new_from_vec]
  - shaped by: param `encoding` expanded from `Encoding` — variants [encoding_new_from_id, self]
  - shaped by: param `payload` expanded from `ZBytes` — variants [zbytes_new_from_vec]
  - shaped by: domain error `Error` decomposed → onError [message] (binding failures → onBindingError)
...
- `publisher_delete` — `fun delete(attachment: ByteArray?, onBindingError: JniErrorHandler<Unit>, onError: ErrorHandler<Unit>)`
  - shaped by: param `attachment` expanded from `ZBytes` — variants [zbytes_new_from_vec]
  - shaped by: domain error `Error` decomposed → onError [message] (binding failures → onBindingError)
- `publisher_put` — `fun put(payload: ByteArray, encodingSel: Int, encoding00: Int?, encoding01: ByteArray?, encoding1: Encoding?, attachment: ByteArray?, onBindingError: JniErrorHandler<Unit>, onError: ErrorHandler<Unit>)`
  - shaped by: param `attachment` expanded from `ZBytes` — variants [zbytes_new_from_vec]
  - shaped by: param `encoding` expanded from `Encoding` — variants [encoding_new_from_id, self]
  - shaped by: param `payload` expanded from `ZBytes` — variants [zbytes_new_from_vec]
  - shaped by: domain error `Error` decomposed → onError [message] (binding failures → onBindingError)
...
- `querier_get` — `fun get(parameters: String?, payload: ByteArray?, encodingSel: Int, encoding00: Int?, encoding01: ByteArray?, encoding1: Encoding?, attachment: ByteArray?, callback: ReplyCallback, onClose: VoidCallback, onBindingError: JniErrorHandler<Unit>, onError: ErrorHandler<Unit>)`
  - shaped by: param `attachment` expanded from `ZBytes` — variants [zbytes_new_from_vec]
  - shaped by: param `encoding` expanded from `Encoding` — variants [encoding_new_from_id, self]
  - shaped by: param `payload` expanded from `ZBytes` — variants [zbytes_new_from_vec]
  - shaped by: domain error `Error` decomposed → onError [message] (binding failures → onBindingError)
...
- `query_reply_delete` — `fun replyDelete(keyExprSel: Int, keyExpr0: String?, keyExpr1: KeyExpr?, timestamp: Timestamp?, attachment: ByteArray?, express: Boolean?, onBindingError: JniErrorHandler<Unit>, onError: ErrorHandler<Unit>)`
  ...
  - shaped by: param `key_expr` expanded from `KeyExpr` — variants [keyexpr_new_try_from, self]
  - shaped by: domain error `Error` decomposed → onError [message] (binding failures → onBindingError)
- `query_reply_error` — `fun replyError(payload: ByteArray, encodingSel: Int, encoding00: Int?, encoding01: ByteArray?, encoding1: Encoding?, onBindingError: JniErrorHandler<Unit>, onError: ErrorHandler<Unit>)`
  - shaped by: param `encoding` expanded from `Encoding` — variants [encoding_new_from_id, self]
  - shaped by: param `payload` expanded from `ZBytes` — variants [zbytes_new_from_vec]
  - shaped by: domain error `Error` decomposed → onError [message] (binding failures → onBindingError)
- `query_reply_sample` — `fun replySample(sample: Sample, onBindingError: JniErrorHandler<Unit>, onError: ErrorHandler<Unit>)`
  - shaped by: domain error `Error` decomposed → onError [message] (binding failures → onBindingError)
- `query_reply_success` — `fun replySuccess(keyExprSel: Int, keyExpr0: String?, keyExpr1: KeyExpr?, payload: ByteArray, encodingSel: Int, encoding00: Int?, encoding01: ByteArray?, encoding1: Encoding?, timestamp: Timestamp?, attachment: ByteArray?, express: Boolean?, onBindingError: JniErrorHandler<Unit>, onError: ErrorHandler<Unit>)`
  - shaped by: param `attachment` expanded from `ZBytes` — variants [zbytes_new_from_vec]
  - shaped by: param `encoding` expanded from `Encoding` — variants [encoding_new_from_id, self]
  - shaped by: param `key_expr` expanded from `KeyExpr` — variants [keyexpr_new_try_from, self]
  - shaped by: param `payload` expanded from `ZBytes` — variants [zbytes_new_from_vec]
...
- `session_delete` — `fun delete(keyExprSel: Int, keyExpr0: String?, keyExpr1: KeyExpr?, congestionControl: CongestionControl?, priority: Priority?, express: Boolean?, attachment: ByteArray?, reliability: Reliability?, onBindingError: JniErrorHandler<Unit>, onError: ErrorHandler<Unit>)`
  ...
  - shaped by: param `key_expr` expanded from `KeyExpr` — variants [keyexpr_new_try_from, self]
  - shaped by: domain error `Error` decomposed → onError [message] (binding failures → onBindingError)
- `session_get` — `fun get(selector: Selector, timeoutMs: Long?, target: QueryTarget?, consolidation: ConsolidationMode?, acceptReplies: ReplyKeyExpr?, congestionControl: CongestionControl?, priority: Priority?, express: Boolean?, payload: ByteArray?, encodingSel: Int, encoding00: Int?, encoding01: ByteArray?, encoding1: Encoding?, attachment: ByteArray?, callback: ReplyCallback, onClose: VoidCallback, onBindingError: JniErrorHandler<Unit>, onError: ErrorHandler<Unit>)`
  - shaped by: param `attachment` expanded from `ZBytes` — variants [zbytes_new_from_vec]
  - shaped by: param `encoding` expanded from `Encoding` — variants [encoding_new_from_id, self]
  - shaped by: param `payload` expanded from `ZBytes` — variants [zbytes_new_from_vec]
  - shaped by: domain error `Error` decomposed → onError [message] (binding failures → onBindingError)
...
- `timestamp_stack_get_records` — `fun getRecords(onError: JniErrorHandler<List<TimestampStackRecord>?>): List<TimestampStackRecord>?`
  - shaped by: return `TimestampStackRecord` decomposed → [point, timestamp__tag, timestamp__uhlc_v0, timestamp__custom_v0] (Callback delivery)
...
- `RecoveryMode`: sealed_class → `io.zenoh.jni.pubsub.RecoveryMode` (wire `?`)
...
- `Selector`: data_class → `io.zenoh.jni.query.Selector` (wire `jni :: objects :: JObject`)
...
- `Error` (never materializes in Kotlin)
