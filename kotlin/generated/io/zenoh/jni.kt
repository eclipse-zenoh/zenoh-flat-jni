...
internal object JNINative {
    ...
    external fun replyGetReplierId(r: Long, errorSink: Any): EntityGlobalId?
    ...
    external fun sampleGetSourceInfo(s: Long, errorSink: Any): SourceInfo?
    ...
    external fun zenohIdToString(z: ByteArray, errorSink: Any, domainSink: Any): String
