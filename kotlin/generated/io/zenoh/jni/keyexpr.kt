...
public class KeyExpr private constructor(initialPtr: Long) : GcNativeHandle(initialPtr) {
    ...
    public fun take(): KeyExpr {
        val p = releaseCell(cell)
        __cleanable?.clean()
        return KeyExpr.fromRawPtr(if (p != 0L) p else cell.get())
    }
    ...
    public companion object {
        ...
        @JvmSynthetic
        internal fun fromRawPtr(initialPtr: Long): KeyExpr = KeyExpr(initialPtr)
