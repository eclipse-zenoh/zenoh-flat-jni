...
public class Config private constructor(initialPtr: Long) : GcNativeHandle(initialPtr) {
    ...
    public fun take(): Config {
        val p = releaseCell(cell)
        __cleanable?.clean()
        return Config.fromRawPtr(if (p != 0L) p else cell.get())
    }
    ...
    public fun newClone(onError: JniErrorHandler<Config?>): Config? {
        ...
        return Config.fromRawPtr(__ret)
    }
    ...
    public companion object {
        ...
        @JvmSynthetic
        internal fun fromRawPtr(initialPtr: Long): Config = Config(initialPtr)
...
internal fun interface ZenohIdFolderRaw<A> {
